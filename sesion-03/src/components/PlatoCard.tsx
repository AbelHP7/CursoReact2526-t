...
const PlatoCard = ({ plato }: PlatoCardProps) => {
    ...
    transition-all duration-300 overflow-hidden border-gray-100 group">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {plato.ingredientes.map((ingrediente, index) => (
                            <span
                                className="bg-orange-50 text-orange-700 rounded-md border-orange-100"
                                key={index} >{ingrediente}</span>
                        ))
                        }
                    </div>
                </div>
